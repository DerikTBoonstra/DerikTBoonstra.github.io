...
<div style="display:flex; align-items:center; gap:8px; margin-bottom:8px; color:black;">
  <label for="method" style="font-weight:600; color:black;">SDR method:</label>
